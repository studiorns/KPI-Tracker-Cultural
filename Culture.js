// Culture Dashboard - Chart Configurations and Data Processing
// This file handles data processing and chart creation for the Culture KPI Dashboard

console.log('Culture.js loaded successfully');
...
function createActualVsForecastChart(canvasId, data, initiative, subInitiative, metric) {
  try {
    ...
    const subInitiativeColors = {
      'Cultural Campaigns': CHART_COLORS.blue,
      'Cultural Campaigns UAE': CHART_COLORS.green
    };
    ...
    options: {
      ...
      scales: {
        ...
        y: {
          ...
          min: 0,
          max: 400, // Increased to better visualize values that might be higher for Culture
          grid: {
